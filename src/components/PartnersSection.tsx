const techPartners = [
  ...
  },
  {
    name: "React",
    logo: (
      <svg viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor" className="h-12 text-[#61DAFB]">
  ...
  },
  {
    name: "Next.js",
    logo: (
      <svg viewBox="0 0 180 180" fill="currentColor" className="h-12">
  ...
  },
  {
    name: "Figma",
    logo: (
      <svg viewBox="0 0 38 57" fill="currentColor" className="h-12 w-12">
  ...
  },
  {
    name: "Stripe",
    logo: (
      <svg viewBox="0 0 60 25" fill="currentColor" className="h-12 text-[#635BFF]">
    ...
    <section className="partners-section reveal">
      <div className="section-shell">
        <div className="partners-heading text-center mb-16">
          <p className="partners-kicker">Collaboration</p>
