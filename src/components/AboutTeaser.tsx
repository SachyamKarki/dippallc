...
export default function AboutTeaser() {
  ...
  return (
    <section className="py-32 bg-black reveal overflow-hidden" id="vision">
      <div className="section-shell relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none" ref={graphicRef}>
          <div className="graphic-shape w-64 h-64 border border-white rounded-full blur-3xl absolute" />
          <div className="graphic-shape w-96 h-96 border border-white rounded-full blur-2xl absolute opacity-30" />
        </div>

        <div className="max-w-3xl mx-auto text-center relative z-10">
          <h2 className="text-sm font-bold uppercase tracking-[0.16em] text-white/40 mb-8">
            Strategic Identity
          </h2>
          <h3 className="text-5xl md:text-7xl font-bold text-white mb-10 tracking-tight leading-none">
