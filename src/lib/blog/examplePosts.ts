...
export const examplePosts: readonly BlogPost[] = [
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-slate-950/10 via-white to-blue-600/15" },
  ...
  },
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-emerald-500/10 via-white to-slate-950/10" },
  ...
  },
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-indigo-500/12 via-white to-slate-900/10" },
  ...
  },
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-fuchsia-500/10 via-white to-slate-950/10" },
  ...
  },
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-amber-500/12 via-white to-slate-950/10" },
  ...
  },
  {
    ...
    source: "example",
    cover: { kind: "gradient", className: "from-cyan-500/10 via-white to-slate-950/10" },
